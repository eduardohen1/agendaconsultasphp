...
<body>
	...
	<div class="container">
		<div class="jumbotron">
	        <h2><?php echo("Bem-vindo ".$vvNomeUsuario." ao sistema de agendamento de consultas!");?></h2>
	        <p><h3>O que deseja fazer?</h3></p><br/>
				<p><a class="btn btn-success btn-lg" href="#" role="button"  data-toggle="modal" data-target="#myModal">Marcar consulta</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a class="btn btn-success btn-lg" href="agendamentos.php" role="button">Ver suas consultas</a>
				<?php 
					if($vvTipoUsuario == 0){
						echo("&nbsp;&nbsp;&nbsp;&nbsp;");
						echo("<a class='btn btn-success btn-lg' href='confirmar.php' role='button'>Confirmar consultas</a>");
					}
				?>
				</p> 
      	</div>
