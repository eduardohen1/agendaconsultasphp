...
(function (factory) {
    ...
    return moment.defineLocale('pt-br', {
        ...
        longDateFormat : {
            ...
            L : 'DD/MM/YYYY',
            LL : 'D [de] MMMM [de] YYYY',
            LLL : 'D [de] MMMM [de] YYYY [A s] LT',
            LLLL : 'dddd, D [de] MMMM [de] YYYY [A s] LT'
        },
        calendar : {
            sameDay: '[Hoje e s] LT',
            nextDay: '[Amanha e s] LT',
            nextWeek: 'dddd [e s] LT',
            lastDay: '[Ontem e s] LT',
            lastWeek: function () {
                return (this.day() === 0 || this.day() === 6) ?
                    '[ultimo] dddd [A s] LT' : // Saturday + Sunday
                    '[ultima] dddd [A s] LT'; // Monday - Friday
            },
            sameElse: 'L'
        },
        relativeTime : {
